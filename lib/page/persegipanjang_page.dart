import 'package:bangun_datar_app/controller/persegi_panjang_controller.dart';
...
class PersegiPanjangPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset("aset/20220419_110926Gambar_Bangun_Datar_Persegi_Panjang_dan_Rumusnya.png", height: 100),
          Padding(
